...
ALTER TABLE [dbo].[reviews]  WITH CHECK ADD  CONSTRAINT [fk_reviews_hotels] FOREIGN KEY (hotels_id) REFERENCES hotels(id) ON DELETE CASCADE
REFERENCES [dbo].[hotels] ([id])
ON DELETE CASCADE
 
ALTER TABLE [dbo].[reviews] WITH CHECK ADD CONSTRAINT [fk_reviewFK_States_Countries]
