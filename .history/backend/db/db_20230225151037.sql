...
create table users(
  ...
  created_at date default current_date
    ...
    INSERT INTO places( title, where_to_stay, description, image_url1, image_url2, image_url3 ) VALUES( 'Petra: Inside The Lost City', 'Find the nearby hotels in Petra and check hotel availability by date and prices.', ' The place lies around 358.2 km from Paris that makes it a perfect spot for a day trip. The trip from Paris to Mont Saint Michel could be highly rewarding if you are sorted enough with the itinerary and other essential preparations.', 'https://bigseventravel.com/wp-content/uploads/2020/11/52833015_2522091817819575_4671529116317515776_o-1920x1079.jpg', 'https://citywonders.com/media/20929/paris-mont-st-michel-abbey.jpg', 'https://traveladdicts.net/wp-content/uploads/2009/08/France-Normandy-Mont-St-Michel-town.jpg');
