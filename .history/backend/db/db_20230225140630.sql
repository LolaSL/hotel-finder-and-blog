...
create table users(
  ...
  created_at date default current_date
    ...
    INSERT INTO hotels( name, location, price_range) VALUES('TBA Times Square', 'New York, U', 4);
    INSERT INTO hotels( name, location, price_range) VALUES( 'Metropolis', 'Milano, Italy', 3);
    INSERT INTO hotels( name, location, price_range) VALUES( 'AirAstana', 'Astana, Kazakhstan', 3);
    INSERT INTO hotels( name, location, price_range) VALUES( 'Paris Casino', 'las Vegas, USA', 3);
