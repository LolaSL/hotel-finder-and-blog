...
create table users(
  ...
  created_at date default current_date
    ...
    INSERT INTO places( title, where_to_stay, description, image_url1, image_url2, image_url3 ) VALUES( 'Petra: Inside The Lost City', 'Find the nearby hotels in Petra and check hotel availability by date and prices.', 'The lost city of Petra Jordan is emerging as one of the most popular places to visit in the Middle East. It is relatively safe and affordable, and there are some amazing things to see. Petra was named one of the New 7 Wonders of the World by UNESCO in 2007. The organization described the historic site as “one of the most precious cultural properties of human cultural heritage." Petra also goes by the name  “Red Rose City.” This name stems from the pink color of the stone that the Nabateans carved to build the city. Petra has been a popular film location in Jordan  and is iconic around the world. The "Mummy Returns" and "Indiana Jones" and "Transformers" (second part) and the "Last Crusade" both had their crews shoot a few scenes at Petra. Petra is an incredibly ancient city carved into the rocks in southern Jordan, and the ruins inside Petra Jordan can be explored by walking on foot or riding a camel. or donkey.', 'https://s3.amazonaws.com/factinformer.com/subjects/37/coverPhoto.1&auto=format&fit=crop&w=1350&q=80', 'https://www.atlasandboots.com/wp-content/uploads/2016/04/Visiting-Petra-PW-15.jpg', 'https://www.weekendnotes.com/im/009/06/petra-jordan-the-treasury-day-nabathean-carving-ad21.jpg');
