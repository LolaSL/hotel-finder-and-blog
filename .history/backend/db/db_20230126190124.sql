...
create table users(
  ...
  created_at date default current_date
    ...
    INSERT INTO places( title, description) VALUES( 'Walking with Giants in Northern Thailand', 'On a jungle ridge in the Golden Triangle in northern Thailand, the resort is the perfect vantage point to gaze out over the countrys historic Lanna kingdom, as well as Laos and Myanmar. Lounge on your balcony shaded by lush trees, enjoy indulgent spa treatments surrounded by misty mountains, sip sundowners with a view of the Mekhong river and, all around, catch glimpses of the gentle giants that call the camp their home.');
