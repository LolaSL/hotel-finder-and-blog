...
create table users(
 ...
 INSERT INTO users( name, email, password) VALUES( 'test', 'Test', 'test1@example.com', 123456);
 INSERT INTO users( name, email, password) VALUES( 'test', 'Test', 'test1@example.com', 123456); INSERT INTO users( name, email, password) VALUES( 'test', 'Test', 'test1@example.com', 123456);
