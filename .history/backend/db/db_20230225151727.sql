...
Petra was named one of the New 7 Wonders of the World by UNESCO in 2007. The organization described the historic site as “one of the most precious cultural properties of human cultural heritage." Petra also goes by the name  “Red Rose City.” This name stems from the pink color of the stone that the Nabateans carved to build the city. Petra has been a popular film location in Jordan  and is iconic around the world. The Mummy Returns and Indiana Jones and Transformers (second part) and the Last Crusade both had their crews shoot a few scenes at Petra.
