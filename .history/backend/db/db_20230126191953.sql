...
create table users(
  ...
  created_at date default current_date
    ...
    INSERT INTO places( title, where_to_stay, description, image_url1, image_url2, image_url2) VALUES( 'Celebrate holiday season whith magical spring destinations in Europe', 'Sprinkle a dash of novelty on your festivities and embrace the opportunity to celebrate more than just the holiday season this year. In our fast-paced world there is no greater gift than the memories that you create, and the places that you create them. Take the time to indulge in unique customs, inspiring cuisine and breathtaking scenery. Embark on a magical journey as you reconnect with loved ones in Europes most storied destinations this holiday season.', 'https://upload.travelawaits.com/ta/uploads/2022/05/Dutch-windmill-and-colorful-tulips-in-Keukenhof-Garden-scaled-e1651778267949.jpg', 'https://www.smartertravel.com/wp-content/uploads/2020/02/amsterdam-canal-bike-spring.jpg',);
