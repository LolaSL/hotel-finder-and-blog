...
create table users(
  ...
  created_at date default current_date
    ...
    INSERT INTO users( name, email, password) VALUES( 'test', 'Test1', 'test2@example.com', 123456);
    INSERT INTO users( name, email, password) VALUES( 'test', 'Test3', 'test3@example.com', 123456); 
    INSERT INTO users( name, email, password) VALUES( 'test', 'Test4', 'test4@example.com', 123456);
