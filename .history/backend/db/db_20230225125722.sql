...
ALTER TABLE hotels.reviews  WITH CHECK ADD  CONSTRAINT [fk_reviews_hotels] FOREIGN KEY (hotels_id) REFERENCES hotels(id) ON DELETE CASCADE
REFERENCES hotels.hotels([id])
ON DELETE CASCADE;
 
ALTER TABLE hotels.[reviews] WITH CHECK ADD CONSTRAINT [fk_reviews_hotels];
