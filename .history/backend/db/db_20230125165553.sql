...
create table users(
  ...
  created_at date default current_date
    ...
    INSERT INTO users( name, email, password) VALUES( 'test', 'Test', 'test1@example.com', '111111');
    INSERT INTO users( name, email, password) VALUES( 'test', 'Test1', 'test2@example.com', 222222);
    INSERT INTO users( name, email, password) VALUES( 'test', 'Test3', 'test3@example.com', 333333); 
    INSERT INTO users( name, email, password) VALUES( 'test', 'Test4', 'test4@example.com', 444444);
