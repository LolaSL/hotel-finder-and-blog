...
exports.updatePlace = (req, res) => {
  ...
  pool.query('SELECT * FROM places WHERE id = $1;',
    [id], (error, results) => {
      ...
      pool.query('UPDATE places SET title = $1,  where_to_stay=$2, description=$3, image_url1=$4, image_url2, image_url description = $2  WHERE id = $3;', [title, where_to_stay, description, image_url1, image_url2, image_url3, id], (error, results) => {
        if (error) throw error;
