...
exports.createPlace = (req, res) => {
  ...
  pool.query('INSERT INTO places(title, description,  photo, slug,  uid ) VALUES( $1, $2, $3, $4, $5);', [title, whete_to_stay, description, image_url1, image_url2, image_url3], (error, results) => {
