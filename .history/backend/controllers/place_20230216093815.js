...
//       }
//       pool.query('UPDATE places SET title = $1,  where_to_stay = $2, descriptio = $3, image_url1 = $4, image_url2 = $5, image_url = $6  WHERE id = $7;', [title, where_to_stay, description, image_url1, image_url2, image_url3, id], (error, results) => {
//         if (error) throw error;
...
exports.updatePlace = async (req, res) => {
  try {
    const results = await db.query(
      ...
      [req.body.title, req.body.where_to_stay, req.body.description, req.body.image_url1, req.body.image_url2, image_url3, req.params.id]
    );
...
exports.deletePlace = (req, res) => {
  ...
  pool.query('SELECT * FROM places WHERE id = $1;',
    [id], (error, results) => {
      ...
      pool.query('DELETE FROM places WHERE id = $1;',
        [id], (error, results) => {
          if (error) throw error;
