  ...
  return (
    ...
    >
      <Nav className="flex-column text-white w-100 pt-4">
        ...
        <Link to="/time-to-visit" className="m-3 text-white a-link">
          {" "}
          Best time to visit
        </Link>
        <Link to="/wheather-climate" className="m-3 text-white a-link">
          Wheather and Climate
        </Link>
        <Link to="/reasons-to-visit" className="m-3 text-white a-link">
          Reasons to visit Israel
        </Link>
        <Link to="/aeroport-quide" className="m-3 text-white a-link">
          Ben Gurion Aeroport guide
        </Link>
        <Link to="/destinations" className="m-3 text-white a-link">
         Top destinations
        </Link>
      </Nav>
    </div>
