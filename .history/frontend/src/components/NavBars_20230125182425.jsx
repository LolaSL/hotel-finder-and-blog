...
function Navbars() {
 ...
 {isAuth ? ( <div className="d-flex "me-auto w-100 justify-content-end">
          <Link className="nav-link" to="/" rel="noopener noreferrer">
            <Navbar.Brand className="brand fw-bold">Hotel Finder</Navbar.Brand>
          </Link>
          <Link className="nav-link" to="/logout" rel="noopener noreferrer">
            <Navbar.Brand className="brand fw-bold">Logout</Navbar.Brand>
          </Link>
        </div>
          ) : (
