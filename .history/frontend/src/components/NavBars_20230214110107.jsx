      ...
      <Container className="container d-flex">
        {isAuth ? (
          ...
          <div className="">
            ...
            <NavDropdown  NavDropdown title={userInfo.id} id="basic-nav-dropdown" className=" me-auto fw-bold justify-content-end">
                  ...
                  <div>
                    <NavDropdown  title="Journey of all experiences" id="basic-nav-dropdown">
                      <LinkContainer  className="dropdown-item" to='/journey'>
                        <NavDropdown .Item>Find your next trip and destination</NavDropdown>
                      </LinkContainer>
