...
const JourneyOfAllExperiences = () => {
  ...
  return (
    <div>
      ...
      <Container>
<div>
        <iframe id="VideoWorker-0" frameborder="0" allowfullscreen  title="Life is impossible withour travellings" width="600" height="360" src="https://assets.mixkit.co/videos/preview/mixkit-waterfall-in-forest-2213-large.mp4">
