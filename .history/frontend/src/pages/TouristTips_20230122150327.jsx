      ...
      <Container className="container">
        <section className="d-block juctify-content-center">
          <article className="d-block">
            ...
            <p className="mt-2 mb-2 display-6">Are you thinking about taking some time off and organizing a lovely trip somewhere you have never
            ...
            you will find the perfect accommodation and save some extra money.</p>
          </article>
          <article>
            <h2>
            1. Calculate your budget.</h2> <p className="mt-2 mb-2"> We know already that you would love to stay
            ...
            well your budget. Or just look at your bank account.</p>
          </article>
          <article>
          <div className="mb-4 mt-4">
              <img src="./images/2.jpg" alt="Winter" className="img-thumbnail image rounded mx-auto d-block" />
            </div>
            <h2>
            2. Travel during low season.</h2> <p className="mt-2 mb-2"> It could happen that you have no choice
            but to organize your trip during August, Easter or Christmas
            holidays. Of course during this time your journey becomes more
            expensive. If you have the power to choose, then do not travel during
            this time. The difference between traveling in September instead of
            August can be seen from your wallet. Think about it!</p>
          </article>
          <article>
            <h2>
            3. Do not forget it is your trip.</h2> <p className="mt-2 mb-2">What are you looking for in this
            ...
            type of accommodation you will be staying in.</p>
          </article>
          <article>
            <h2>
            4. What type of accommodation do you prefer?</h2> <p className="mt-2 mb-2">This point goes hand in
            ...
            B and cottages. Choose which one suits you the most.</p>
          </article>
          <article>
          <div className="mb-4 mt-4">
              <img src="./images/3.jpg" alt="House" className="img-thumbnail image rounded mx-auto d-block" />
            </div>
            <h2>
            5. Bear in mind what accommodations can offer.</h2> <p className="mt-2 mb-2">Are you looking for a
          ...
          <article>
          <div className="mb-4 mt-4">
              <img src="./images/4.jpg" alt="Sweemming pool" className="img-thumbnail image rounded mx-auto d-block" />
            </div>
            <h2>
            6. Meals during the trip.</h2> <p className="mt-2 mb-2">Are you organizing a trip with friends or a
            ...
            just want to leave your room to eat in the hotels dining room.
            Think about it and decide what suits you best.</p>
          </article>
          <article>
          <div className="mb-4 mt-4">
              <img src="./images/5.jpg" alt="Rest" className="img-thumbnail image rounded mx-auto d-block" />
            </div>
            <h2>
            7. Cheap can sometimes be expensive</h2> <p className="mt-2 mb-2">Never trust bargains. Always
          ...
          <article>
          <div className="mb-4 mt-4">
              <img src="./images/6.jpg" alt="Breakfast" className="img-thumbnail image rounded mx-auto d-block" />
            </div>
            <h2>
            8. Always book in advance and with the refund option.</h2> <p className="mt-2 mb-2">With this
            ...
            reservation on the same day of your arrival. Despite this, do not
            forget to carefully read about cancellation policies!</p>
          </article>
          <article>
          <div className="mb-4 mt-4">
              <img src="./images/7.jpg" alt="Public transportation" className="img-thumbnail image rounded mx-auto d-block" />
            </div>
            <h2>
            9. Find out the cost of public transports.</h2> <p className="mt-2 mb-2">Look up on the internet
            ...
            visit in more rural areas and reach them by public transports.</p>
          </article>
          <article>
            <h2>
            10. Spend more than one night in the same area.</h2> <p className="mt-2 mb-2">You will probably
            ...
            your plan was to move around, then think carefully.</p>
          </article>
          <article>
            <h2>
            11. Check if there are any important events in the area during your
            stay.</h2><p className="mt-2 mb-2"> Concerts, or events such as St. Patrick in Dublin or the
            ...
            plan well your stay.</p>
          </article>
          <article>
          <div className="mb-4 mt-4">
              <img src="./images/8.jpg" alt="Party" className="img-thumbnail image rounded mx-auto d-block" />
            </div>
            <h2>
            12. Forget about Friday Night.</h2><p className="mt-2 mb-2"> Could be that this piece of advice is
            ...
            after you visited the city.</p>
          </article>
          <article>
            <h2>
            13. Ratings and opinions are important.</h2><p className="mt-2 mb-2">This is key when you are
            ...
            Do not become obsessed by them.</p> 
          </article>
          <article>
            <h2>
            14. Search for promotional codes on the internet.</h2><p className="mt-2 mb-2"> Many hotels offer
            ...
            recommend you to download the app Honey.</p>
          </article>
          <article>
          <div className="mb-4 mt-4">
              <img src="./images/9.jpg" alt="internet search" className="img-thumbnail image rounded mx-auto d-block" />
            </div>
            <h2>
            15. Sign up for newsletters.</h2><p className="mt-2 mb-2">Do you want to be the first one to know
            ...
            offers, the newsletter will always inform you about them.</p>
          </article>
          <article>
            <p className="mt-2 mb-2">We can assure you that if you try to follow these <strong><i>tips to find your
            ideal accommodation</i></strong>, not only you will succeed, but you will also
            manage to save some money. Go ahead and organize your trip!</p>
          </article>
        </section>
      </Container>
    </div>
