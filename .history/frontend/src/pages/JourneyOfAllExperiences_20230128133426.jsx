...
const JourneyOfAllExperiences = () => {
  ...
  return (
    <div>
      ...
      <section>
        <image src="./images/17.jpg" alt="Mon Saint Michel"  className="img-thumbnail image rounded mx-auto d-block"></image>
      <article className="article mt-4 mb-4">
        ...
        <Link className='link font-weight-light' to={`/blog?redirect=${redirect}`}> Find your new adventure trip and destination</Link>

</article>
</section>
      <section>
      <image src="./images/18.jpg" alt="Tourist tips"  className="img-thumbnail image rounded mx-auto d-block"></image>
