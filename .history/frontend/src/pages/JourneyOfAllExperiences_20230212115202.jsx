...
const JourneyOfAllExperiences = () => {
  ...
  return (
    <div>
      ...
      <section>
        <div><img  src="./images/18.jpg" alt="Mon Saint Michel"  className="img-thumbnail image rounded mx-auto d-block" /></div>
      <article className="article mt-4 mb-4">
        ...
        <Link className='link font-weight-light' to={`/blog?redirect=${redirect}`}> Find your next adventure trip and destination</Link>
</article>
<article className="article mt-4 mb-4">

        <Link className='link font-weight-light' to={`/places?redirect=${redirect}`}> Find your next adventure trip and destination</Link>
</article>
</section>
      <section>
      <div><img src="./images/17.jpg" alt="Tourist tips"  className="img-thumbnail image rounded mx-auto d-block" /></div>
