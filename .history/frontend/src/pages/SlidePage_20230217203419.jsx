      ...
      <Container className="container">
        <div>
          ...
          <section className="d-block juctify-content-center">
            ...
            <h2 className="mt-2 mb-2 display-4 text-center mt-4 mb-4">7. Mahne Yehuda Market.</h2>
            <div className="mb-4 mt-4">
              <img
                src="./images/26.jpg"
            ...
            <article>
              Do not be shy when you wander through this market full of delicious
              bites. Try the various types of halva, breads, nuts, dates,
              olives, hummus, pastas, and freshly squeezed juices. Take
            ...
            <h2 className="mt-2 mb-2 display-4 text-center mt-4 mb-4">8. Cheap can sometimes be expensive</h2> 
             <div className="mb-4 mt-4">
                <img
                  src="./images/6.jpg"
                  alt="Breakfast"
