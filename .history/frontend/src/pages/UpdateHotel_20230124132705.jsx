...
const UpdateHotel = (props) => {
  ...
  return (
    <div>
      <h1 className="font-weight-light display-1 text-center">Update Hotel</h1>
      <Container className="container">
        ...
        <div className="form-row d-flex">
          ...
          <div className="form-group">
            <label htmlFor="location" className="mb-2 fw-bold ">
              Location
            </label>
            <input
              value={location}
          ...
          <div className="form-group mt-2">
            <label htmlFor="price_range" className="mb-2 fw-bold ">
              Price Range
            </label>
            <input
              value={priceRange}
