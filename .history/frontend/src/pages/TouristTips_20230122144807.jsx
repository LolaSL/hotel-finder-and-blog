  ...
  return (
    <div>
      ...
      <Container className="container">
        <section className="d-block juctify-content-">
          <article className="d-block">
            <div className="mb-4 mt-4">
              <img src="./images/1.jpg" alt="Eifel Tower" className="rounded mx-auto d-block" />
            </div>
          ...
          <article>
          <div className="mb-4 mt-4">
              <img src="./images/2.jpg" alt="Winter" className="rounded mx-auto d-block" />
            </div>
            <h2>
          ...
          <article>
          <div className="mb-4 mt-4">
              <img src="./images/3.jpg" alt="House" className="rounded mx-auto d-block" />
            </div>
            <h2>
          ...
          <article>
          <div className="mb-4 mt-4">
              <img src="./images/4.jpg" alt="Sweemming pool" className="rounded mx-auto d-block" />
            </div>
            <h2>
          ...
          <article>
          <div className="mb-4 mt-4">
              <img src="./images/5.jpg" alt="Rest" className="rounded mx-auto d-block" />
            </div>
            <h2>
          ...
          <article>
          <div className="mb-4 mt-4">
              <img src="./images/6.jpg" alt="Breakfast" className="rounded mx-auto d-block" />
            </div>
            <h2>
          ...
          <article>
          <div className="mb-4 mt-4">
              <img src="./images/7.jpg" alt="Public transportation" className="rounded mx-auto d-block" />
            </div>
            <h2>
