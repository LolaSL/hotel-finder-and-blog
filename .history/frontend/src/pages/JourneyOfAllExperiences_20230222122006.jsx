...
<div>
      ...
      <h2 className="font-weight-light display-6 text-center">
        ...
        world. Let your imagination run wild.
          ...
          <iframe id="VideoWorker-0" className="responsive" frameborder="0" allowfullscreen  title="Life is impossible withour travellings" width="450" height="300" src="https://assets.mixkit.co/videos/preview/mixkit-waterfall-in-forest-2213-large.mp4"></iframe></div>
      <section>
        {/* <div>
          <img
            src="./images/18.jpg"
