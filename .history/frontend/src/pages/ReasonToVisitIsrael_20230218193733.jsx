      ...
      <Container className="container">
        ...
        <section className="d-block juctify-content-center">
          ...
          <article className="font-weight-light">
            ...
            clean beaches run the length of the city – meaning there’s a unique
            mix of sophistication and relaxation here. The ancient city of Jaffa
            provides an atmospheric counterpoint to Tel Aviv’s soaring towers
            and famous curved white Bauhaus buildings, a legacy of the 1930s.
          </article>
        </section>
      </Container>
      <Menu />
