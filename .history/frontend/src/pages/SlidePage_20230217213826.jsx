      ...
      <Container className="container">
        <div>
          ...
          <section className="d-block juctify-content-center">
            ...
            <article>
              ...
              yourself a couple of hours to roam the grounds.
                      ...
                      <h2 className="mt-2 mb-2 display-4 text-center mt-4 mb-4">15.Tiberias .</h2>
         ...
         <article>
                ...
                pilgrimage sites including the Tomb of Maimonides and Abulafia
                (Etz Chaim) Synagogue. The waterfront features the
                restaurant-lined Yigal Allon Promenade, a marina and a fish
                market. South of the city, Hamat Tiberias National Park is home
                to famed mineral hot springs dating to antiquity.
