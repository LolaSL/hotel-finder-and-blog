        ...
        <div>
          ...
          <section className="d-block juctify-content-center">
            ...
            <article>
              ...
              Hezekiah Tunnel, which are part of an archaeological park. Splash
              through the Siloam Tunnel where water from the early spring still
              flows. It is worth noting that the site, occupied by Israel, is
              controversial in terms of the Israeli-Palestinian conflict.
            </article>
            <h2 className="mt-2 mb-2 display-4 text-center mt-4 mb-4">9. Via Dolorosa.</h2>
            <div className="mb-4 mt-4">
              <img
                src="./images/28.jpg"
                alt="Via Dolorosa"
