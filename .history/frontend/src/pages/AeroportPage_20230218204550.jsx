      ...
      <Container className="container">
        ...
        <section className="d-block juctify-content-center">
          ...
          <article className="font-weight-light">
            ...
            lots if you’re in a private vehicle. Likely, you will be traveling
            throughout Israel on a private tour that will include transportation
            to and from the airport. At the airport, you’ll also have access to
            car rental agencies: Avis, Budge, Dollar, Eldan, Hertz, and Sixt.
          </article>
        </section>
      </Container>
      <Menu />
