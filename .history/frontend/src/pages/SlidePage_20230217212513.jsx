      ...
      <Container className="container">
        <div>
          ...
          <section className="d-block juctify-content-center">
            ...
            <article>
              The vast Negev desert, which encompasses more than half of
              Israel land area, is home to the Makhtesh Ramon, a large erosion
              crater. Bedouins make their home throughout the desert, and some
              tours will allow you to meet a family in person. Jeep, camel, and
              hiking tours are popular in this area as is rappelling off of the
              edge into the Ramon crater.
            </article>
            <h2 className="mt-2 mb-2 display-4 text-center mt-4 mb-4">13. Dead Sea.</h2>
              <div className="mb-4 mt-4">
                <img
                  src="./images/32.jpg"
                  alt="Dead Sea"
