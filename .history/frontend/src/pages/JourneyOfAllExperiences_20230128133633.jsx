...
const JourneyOfAllExperiences = () => {
  ...
  return (
    <div>
      ...
      <section>
        <div><image  src="./images/17.jpg" alt="Mon Saint Michel"  className="img-thumbnail image rounded mx-auto d-block" /></div>
      ...
      <section>
      <image src="./images/18.jpg" alt="Tourist tips"  className="img-thumbnail image rounded mx-auto d-block" />
