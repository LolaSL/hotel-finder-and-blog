...
const HotelTips = () => {
  return (
    <Container className="container">
      ...
      <section>
        <h2 className="mt-2 mb-2 display-6  mt-4 mb-4">Tip to find hotel</h2>
...
Make certain the resort you choose has a good reputation. Make certain to read genuine visitor reviews. The fact that majority of visitors like to read reviews prior to making a hotel reservation. When you’re looking for a fantastic location, reviews are readily available.
 Analyzing reviews about different hotels provides you with valuable insight. 
        </article>
      </section>
    </Container>
  );
