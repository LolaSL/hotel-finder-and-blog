  ...
  return (
    <div>
      ...
      <article>
        ...
        <Link className='link font-weight-light' to={`/blog?redirect=${redirect}`}> Find your new adventure trip</Link>
      ...
      <Link className='link font-weight-light' to={`/tips?redirect=${redirect}`}> The est tourist tips for your unforgettable trip.</Link>
