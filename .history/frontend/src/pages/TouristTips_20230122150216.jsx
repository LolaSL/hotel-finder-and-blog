      ...
      <Container className="container">
        <section className="d-block juctify-content-center">
          ...
          <article>
            ...
            stay.</h2><pclassName="mt-2 mb-2"> Concerts, or events such as St. Patrick in Dublin or the
            ...
            plan well your stay.</pclassName=>
          </article>
          <article>
          <div className="mb-4 mt-4">
            ...
            <h2>
            12. Forget about Friday Night.</h2><p> Could be that this piece of advice is
