      ...
      <Container className="container">
        ...
        <section className="d-block juctify-content-center">
          ...
          <article className="font-weight-light">
            ...
            passengers flying through <strong>Terminal 1</strong>, you can park directly in front
            of the terminal, while those flying through <strong>Terminal 3</strong> can find
            parking in the Vineyard and Orchard lots. Short-term parking is 18
            new shekels per hour (and 4 new shekels every additional 15
            minutes), or a maximum of 40 new shekels per day. Likewise,
            long-term parking is 40 new shekels per day. 
          </article>
          <div className="mb-4 mt-4">
            <h2 className="font-weight-light display-4 text-center mt-4 mb-4">
              u
