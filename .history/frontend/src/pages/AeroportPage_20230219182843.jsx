      ...
      <Container className="container">
        ...
        <section className="d-block juctify-content-center">
          ...
          <div className="mb-4 mt-4">
            ...
            <img
              src="./images/53.jpg"
              alt="WiFi and Charging Stations"
              className="img-thumbnail image rounded mx-auto d-block"
            />
          </div>
          <article className="font-weight-light">
            TFree WiFi is available everywhere, and all of the concourses have charging stations. Keep in mind that electric outlets are 220 volts, 50Hz; and two-pronged European-style round or three-pronged plugs are used.
          </article>
          <div className="mb-4 mt-4">
            <h2 className="font-weight-light display-4 text-center mt-4 mb-4">
              Where to Shop
