      ...
      <Container className="container">
        <div>
          ...
          <section className="d-block juctify-content-center">
            ...
            <article>
              Archaeological digs still happen in the City of David, a
              settlement from the Canaanite period, and ancient relics from the
              Bronze Age to the Iron Age are constantly being discovered. See
              the Gihon Spring and the Pools of Siloam, and walk through
              Hezekiah’s Tunnel, which are part of an archaeological park.
              Splash through the Siloam Tunnel where water from the early spring
              still flows. It’s worth noting that the site, occupied by Israel,
              is controversial in terms of the Israeli-Palestinian conflict.
            </article>
            <article>
