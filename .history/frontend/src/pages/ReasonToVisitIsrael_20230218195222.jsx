      ...
      <Container className="container">
        ...
        <section className="d-block juctify-content-center">
          ...
          <div className="mb-4 mt-4">
            <img
              src="./images/45.jpg"
              alt="Delicious Israeli Cuisine"
              className="img-thumbnail image rounded mx-auto d-block"
            />
          </div>
          <article className="font-weight-light">
            It’s not called the Land of Milk and Honey for nothing! Thanks to
            ...
            market cuisine that you’ll find served throughout the country.
