  ...
  return (
    <Container className="container">
      ...
      <section>
        ...
        <article className=" font-weight-light article mt-4 mb-4">
        As a business traveler, you need to be aware of your dining options. When you’re working long hours, you need a convenient way to acquire your food. When you stay at a hotel, you don’t have to worry about not being able to eat healthy cuisine.
