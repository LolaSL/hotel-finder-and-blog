  ...
  return (
    <div>
      ...
      <Container>
        ...
        <iframe id="VideoWorker-0" frameborder="0" allowfullscreen={true} allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" title="Life is impossible withour travellings" width="640" height="360" src="https://assets.mixkit.co/videos/preview/mixkit-waterfall-in-forest-2213-large.mp4"></iframe>
