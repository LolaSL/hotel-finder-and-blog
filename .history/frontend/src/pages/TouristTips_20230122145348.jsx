        ...
        <section className="d-block juctify-content-center">
          <article className="d-block">
            <div className="mb-4 mt-4">
              <img src="./images/1.jpg" alt="Eifel Tower" className="img-fluid img-thumbnail image rounded mx-auto d-block" />
            </div>
          ...
          <article>
          <div className="mb-4 mt-4">
              <img src="./images/2.jpg" alt="Winter" className="image rounded mx-auto d-block" />
            </div>
            <h2>
