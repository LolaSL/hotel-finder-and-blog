      ...
      <Container className="container">
        <div>
          ...
          <section className="d-block juctify-content-center">
            ...
            <article>
              Also called the Wailing Wall or Kotel, Jerusalem Western Wall is
              a moving sight for people of any faith but particularly those of
              the Jewish religion. Millions of pilgrims make their way here each
            ...
            <article>
            <h2 className="mt-2 mb-2 display-4 text-center mt-4 mb-4">5. The Church of the Holy Sepulchre</h2>
