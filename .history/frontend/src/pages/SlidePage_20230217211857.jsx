      ...
      <Container className="container">
        <div>
          ...
          <section className="d-block juctify-content-center">
            ...
            <h2 className="mt-2 mb-2 display-4 text-center mt-4 mb-4">11. Caesarea.</h2>
            <div className="mb-4 mt-4">
              <img
                src="./images/30.jpg"
                alt="Caesarea"
            ...
            <article>
              An ancient port city on Israel Mediterranean coast, built by
              Herod the Great, Caesarea is an archeological park which includes
              a large Roman amphitheater and remnants of a hippodrome where
            ...
            <h2 className="mt-2 mb-2 display-4 text-center mt-4 mb-4">
               12. Check if there are any important events in the area during
                your stay.
                      </h2>
