...
import { useParams } from "react-router-dom";
import  PlaceFinder from "../apis/PlaceFinder";
import { PlaceContextProvider } from "../apis/PlaceContextProvider";


const PlaceDetail = () => {
  const [place, setPlace] = useContext(PlaceContextProvider)
  const { id } = useParams();
  ...
  return (
    <Container className="mt-3">
      ...
      <Button variant={"outline-dark"}>Back to Blog</Button>
    </Container>
  );
};
