...
const SlidePage = () => {
  return (
    <div className=""> <Container className="container d-flex flex">
      <Helmet>
        <title>Complete guide for visiting Israel</title>
          ...
          <section className="d-block juctify-content-center">
            ...
            <article>
              ...
              marina, which houses over 800 yachts and boats, hotels, it is also home to
              historic, ancient ruins and a stellar contemporary art museum.
            </article>
            </section>
          </section>
        </Container>
