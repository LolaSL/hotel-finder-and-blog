      ...
      <Container className="container">
        <div>
          ...
          <section className="d-block juctify-content-center">
            ...
            <article>
              Near the Jaffa Gate entrance to Jerusalem’s Old City, lies the
              Tower of David, where inside the citadel a museum sits. The museum
              hosts changing exhibits, cultural events and the well-loved
              nighttime showing of The Night Spectacular Sound and Light Show,
              which tells the story of Jerusalem’s history through the use of a
              laser projection system on the tower’s walls.
            </article>
            <h2 className="mt-2 mb-2 display-4 text-center mt-4 mb-4">
              9. Via Dolorosa.
            </h2>
