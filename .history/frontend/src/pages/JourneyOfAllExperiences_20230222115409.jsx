...
const JourneyOfAllExperiences = () => {
  ...
  return (
    <div>
      ...
      <Container>
        {/* <div className="video"> */}
        <iframe id="VideoWorker-0" frameborder="0" allowfullscreen={true} allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" title="Life is impossible withour travellings" width="640" height="360" src="https://www.youtube.com/embed/qBksp9FS3Sc?autohide=1&amp;rel=0&amp;autoplay=0&amp;iv_load_policy=3&amp;modestbranding=1&amp;controls=0&amp;showinfo=0&amp;disablekb=1&amp;enablejsapi=1&amp;origin=https%3A%2F%2Ftheworldtravelguy.com&amp;widgetid=1"></iframe>
